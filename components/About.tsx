      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        */}
        ...
        >
          ...
          */}
          <motion.div 
            className="relative z-10 w-full lg:w-7/12 p-6 md:p-12 lg:p-16"
          ...
          >
            <div className="bg-white/30 backdrop-blur-xl border border-white/40 p-8 md:p-10 rounded-2xl shadow-2xl">
              <h2 className="text-un-accent font-bold tracking-wide uppercase text-sm mb-4 drop-shadow-sm border-l-4 border-un-accent pl-3">O que é a SINU?</h2>
              <h3 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-6 leading-tight drop-shadow-sm">
                Mais que um evento, uma experiência transformadora.
              </h3>
              
              <div className="space-y-6 text-slate-900 text-lg leading-relaxed text-justify font-medium">
