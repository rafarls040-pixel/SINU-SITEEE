...
const CN: React.FC = () => {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-[#00abff] selection:text-white bg-slate-50/50">
      {/* Header/Hero Section */}
      <header className="relative py-16 md:py-24 overflow-hidden bg-[#001d36]">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="flex-1 space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-sky-200 font-bold tracking-widest uppercase text-xs">
              ...
              <div className="bg-black/35 backdrop-blur-md border border-white/15 p-5 md:p-6 rounded-2xl shadow-2xl relative overflow-hidden text-left">
                ...
                <div className="flex items-start gap-3">
                  <Quote className="w-6 h-6 text-[#00abff] shrink-0 mt-0.5 opacity-80" />
                  <div>
                    <span className="text-sky-300 font-sans font-black text-[10px] uppercase tracking-[0.3em] block mb-1">Tema Oficial</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="relative z-10 p-8 md:p-10 w-full space-y-4">
                <div className="flex items-center gap-3">
                  <div className="p-2.5 bg-[#00abff] rounded-2xl text-white shadow-lg flex items-center justify-center shrink-0">
                    <Users className="w-6 h-6" />
                  </div>
                  <div>
                    <span className="text-xs font-bold uppercase tracking-widest text-sky-300 block">Apresentação</span>
            ...
            <motion.section 
              ...
              className="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-slate-100 border-l-8 border-l-[#00abff]"
            >
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100">
                <div className="p-3 bg-[#00abff]/10 rounded-2xl text-[#00abff]">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-slate-100">
                <div className="flex items-center gap-4">
                  <div className="p-3.5 bg-[#00abff]/10 rounded-2xl text-[#00abff] shadow-inner">
                ...
                <a
                  ...
                  download
                  className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white shadow-md hover:shadow-lg hover:scale-105 active:scale-95 transition-all bg-[#00abff] shrink-0"
                >
          ...
          <div className="lg:col-span-1 space-y-8 sticky top-8">
            ...
            >
              ...
              <div className="flex items-center gap-3.5 mb-6 pb-4 border-b border-slate-800">
                <div className="p-3 bg-[#00abff]/20 text-sky-400 rounded-2xl border border-[#00abff]/30">
                  <Users className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-[10px] font-bold uppercase tracking-widest text-sky-400 block">Equipe de Direção</span>
