...
import { Gavel, ArrowLeft, FileText, Users, PlayCircle } from 'lucide-react';
...
const Historic: React.FC = () => {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-[#FF7B01] selection:text-white">
      {/* Header/Hero Section */}
      <header className="relative py-16 md:py-32 overflow-hidden bg-[#602A04]">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-br from-[#602A04] via-[#FF7B01] to-[#602A04]"></div>
          ...
          >
            ...
            <div>
              <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                <span className="text-[#FF7B01] font-bold tracking-widest uppercase text-xs sm:text-sm">
                  Comitê
                </span>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-8">
              ...
              >
                <div className="flex items-center gap-3 mb-8">
                  <div className="p-3 bg-[#602A04]/5 rounded-xl text-[#FF7B01] shadow-inner">
                    <PlayCircle className="w-8 h-8" />
                  </div>
                  <div>
                    <h2 className="text-3xl font-serif font-bold text-slate-900 tracking-tight">Vídeo do Tema</h2>
                    <p className="text-slate-500 text-sm font-medium">Assista à apresentação oficial do tema da CSH</p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-1 space-y-8">
            <motion.section 
              ...
              className="bg-[#602A04]/90 rounded-2xl overflow-hidden border-t-4 border-[#FF7B01] relative backdrop-blur-sm transition-all duration-300 group flex flex-col shadow-xl"
            >
              {/* Glow effect at top */}
              <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-[#FF7B01]/20 to-transparent pointer-events-none"></div>

              <div className="p-5 flex flex-col relative z-10">
                <div className="flex items-center gap-4 mb-2">
                  <div className="p-3 bg-white/10 text-[#FF7B01] rounded-lg group-hover:bg-[#FF7B01] group-hover:text-white transition-all duration-300 shadow-sm">
                    <Users className="w-6 h-6" />
                  </div>
                  <h4 className="text-xl font-serif font-bold leading-tight transition-colors text-white group-hover:text-[#FF7B01]">Mesa Diretora</h4>
                </div>
