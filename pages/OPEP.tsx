...
const OPEP: React.FC = () => {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-[#00FFFF] selection:text-black bg-slate-50/50">
      {/* Header/Hero Section */}
      <header className="relative py-8 sm:py-16 md:py-24 overflow-hidden bg-[#002828]">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            <div className="flex-1 space-y-3 sm:space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-cyan-200 font-bold tracking-widest uppercase text-[10px] sm:text-xs">
              ...
              <div className="bg-black/35 backdrop-blur-md border border-white/15 p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl shadow-2xl relative overflow-hidden text-left">
                ...
                <div className="flex items-start gap-2.5 sm:gap-3">
                  <Quote className="w-5 h-5 sm:w-6 sm:h-6 text-cyan-300 shrink-0 mt-0.5 opacity-80" />
                  <div>
                    <span className="text-cyan-200 font-sans font-black text-[9px] sm:text-[10px] uppercase tracking-[0.25em] sm:tracking-[0.3em] block mb-1">Tema Oficial</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            ...
            >
              <div className="relative z-10 p-5 sm:p-8 md:p-10 w-full space-y-3 sm:space-y-4">
                <div className="flex items-center gap-3">
                  <div className="p-2 sm:p-2.5 bg-[#008B8B] rounded-xl sm:rounded-2xl text-white shadow-lg flex items-center justify-center shrink-0">
                    <Fuel className="w-6 h-6" />
                  </div>
                  <div>
                    <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-cyan-300 block">Apresentação</span>
            ...
            <motion.section 
              ...
              className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-10 shadow-xl border border-slate-100 border-l-6 sm:border-l-8 border-l-[#008B8B]"
            >
              <div className="flex items-center gap-3 mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-slate-100">
                <div className="p-2.5 sm:p-3 bg-[#008B8B]/10 rounded-xl sm:rounded-2xl text-[#008B8B]">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8 pb-4 sm:pb-6 border-b border-slate-100">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="p-2.5 sm:p-3.5 bg-[#008B8B]/10 rounded-xl sm:rounded-2xl text-[#008B8B] shadow-inner">
                ...
                <a
                  ...
                  download
                  className="inline-flex items-center justify-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white shadow-md hover:shadow-lg hover:scale-105 active:scale-95 transition-all bg-[#008B8B] shrink-0 self-start sm:self-auto"
                >
          ...
          <div className="lg:col-span-1 space-y-6 sm:space-y-8 sticky top-8">
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-3.5 mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-slate-800">
                <div className="p-2.5 sm:p-3 bg-[#008B8B]/20 text-cyan-300 rounded-xl sm:rounded-2xl border border-[#008B8B]/30">
                  <Users className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-cyan-300 block">Equipe de Direção</span>
