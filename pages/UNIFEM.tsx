...
const UNIFEM: React.FC = () => {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-[#8609c0] selection:text-white bg-slate-50/50">
      {/* Header/Hero Section */}
      <header className="relative py-8 sm:py-16 md:py-24 overflow-hidden bg-[#2d0052]">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-br from-[#2d0052] via-[#5c0099] to-[#8609c0]"></div>
          <div className="absolute inset-0 opacity-25 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-fuchsia-300 via-transparent to-transparent"></div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            <div className="relative flex items-center justify-center w-32 h-32 sm:w-48 sm:h-48 md:w-56 md:h-56 shrink-0">
              <div className="absolute inset-0 bg-fuchsia-400/20 rounded-full blur-2xl -z-10"></div>
              <img 
            ...
            <div className="flex-1 space-y-3 sm:space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-fuchsia-200 font-bold tracking-widest uppercase text-[10px] sm:text-xs">
              ...
              <div className="bg-black/35 backdrop-blur-md border border-white/15 p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl shadow-2xl relative overflow-hidden text-left">
                <div className="absolute top-0 left-0 w-1.5 h-full bg-[#8609c0]"></div>
                <div className="flex items-start gap-2.5 sm:gap-3">
                  <Quote className="w-5 h-5 sm:w-6 sm:h-6 text-fuchsia-300 shrink-0 mt-0.5 opacity-80" />
                  <div>
                    <span className="text-fuchsia-200 font-sans font-black text-[9px] sm:text-[10px] uppercase tracking-[0.25em] sm:tracking-[0.3em] block mb-1">Tema Oficial</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-8 md:p-10 w-full space-y-3 sm:space-y-4">
                <div className="flex items-center gap-3">
                  <div className="p-2 sm:p-2.5 bg-[#8609c0] rounded-xl sm:rounded-2xl text-white shadow-lg flex items-center justify-center shrink-0">
                    <Users className="w-5 h-5 sm:w-6 sm:h-6" />
                  </div>
                  <div>
                    <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-fuchsia-300 block">Apresentação</span>
            ...
            <motion.section 
              ...
              className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-10 shadow-xl border border-slate-100 border-l-6 sm:border-l-8 border-l-[#8609c0]"
            >
              <div className="flex items-center gap-3 mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-slate-100">
                <div className="p-2.5 sm:p-3 bg-[#8609c0]/10 rounded-xl sm:rounded-2xl text-[#8609c0]">
            ...
            <StudyGuideSection 
              committeeId="unifem" 
              committeeName="Entidade das Nações Unidas para a Igualdade de Gênero (UNIFEM)" 
              accentColor="#8609c0" 
            />
            ...
            >
              <div className="absolute top-0 left-0 right-0 h-2 bg-[#8609c0]" />
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8 pb-4 sm:pb-6 border-b border-slate-100">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="p-2.5 sm:p-3.5 bg-[#8609c0]/10 rounded-xl sm:rounded-2xl text-[#8609c0] shadow-inner">
                ...
                <a
                  href="https://drive.google.com/file/d/1JcXJoB86WP-R1akA3fxCWsOcD08H8MRu/view?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
                  download
                  className="inline-flex items-center justify-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white shadow-md hover:shadow-lg hover:scale-105 active:scale-95 transition-all bg-[#8609c0] shrink-0 self-start sm:self-auto"
                >
            ...
            >
              ...
              <div className="relative w-full aspect-video rounded-xl sm:rounded-2xl md:rounded-3xl overflow-hidden shadow-xl border-2 sm:border-4 border-slate-50 bg-slate-900">
                <iframe 
                  ...
                  title="Vídeo Apresentação UNIFEM"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowFullScreen
                ></iframe>
              </div>
          ...
          <div className="lg:col-span-1 space-y-6 sm:space-y-8 sticky top-8">
            ...
            >
              ...
              <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-[#8609c0] via-fuchsia-400 to-[#8609c0]"></div>
              
              <div className="flex items-center gap-3 sm:gap-3.5 mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-slate-800">
                <div className="p-2.5 sm:p-3 bg-[#8609c0]/20 text-fuchsia-300 rounded-xl sm:rounded-2xl border border-[#8609c0]/30">
                  <Users className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div>
                  <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-fuchsia-300 block">Equipe de Direção</span>
