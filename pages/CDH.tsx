...
const CDH: React.FC = () => {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-[#D68821] selection:text-white bg-slate-50/50">
      {/* Header/Hero Section */}
      <header className="relative py-16 md:py-24 overflow-hidden bg-[#2d1b06]">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="flex-1 space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-[#FFE714] font-bold tracking-widest uppercase text-xs">
              ...
              {/* Theme Callout Box */}
              <div className="bg-black/30 backdrop-blur-md border border-white/15 p-5 md:p-6 rounded-2xl shadow-2xl relative overflow-hidden text-left">
                <div className="absolute top-0 left-0 w-1.5 h-full bg-[#FFE714]"></div>
                <div className="flex items-start gap-3">
                  <Quote className="w-6 h-6 text-[#FFE714] shrink-0 mt-0.5 opacity-80" />
                  <div>
                    <span className="text-[#FFE714] font-sans font-black text-[10px] uppercase tracking-[0.3em] block mb-1">Tema Oficial</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="relative z-10 p-8 md:p-10 w-full space-y-4">
                <div className="flex items-center gap-3">
                  <div className="p-2.5 bg-[#D68821] rounded-2xl text-white shadow-lg flex items-center justify-center shrink-0">
                    <Users className="w-6 h-6" />
                  </div>
                  <div>
                    <span className="text-xs font-bold uppercase tracking-widest text-[#FFE714] block">Apresentação</span>
            ...
            <motion.section 
              ...
              className="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-slate-100 border-l-8 border-l-[#D68821]"
            >
              <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-100">
                <div className="p-3 bg-[#D68821]/10 rounded-2xl text-[#D68821]">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-slate-100">
                <div className="flex items-center gap-4">
                  <div className="p-3.5 bg-[#D68821]/10 rounded-2xl text-[#D68821] shadow-inner">
                ...
                <a
                  ...
                  download
                  className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white shadow-md hover:shadow-lg hover:scale-105 active:scale-95 transition-all bg-[#D68821] shrink-0"
                >
          ...
          <div className="lg:col-span-1 space-y-8 sticky top-8">
            ...
            >
              ...
              <div className="flex items-center gap-3.5 mb-6 pb-4 border-b border-slate-800">
                <div className="p-3 bg-[#D68821]/20 text-[#FFE714] rounded-2xl border border-[#D68821]/30">
                  <Users className="w-6 h-6" />
                </div>
                <div>
